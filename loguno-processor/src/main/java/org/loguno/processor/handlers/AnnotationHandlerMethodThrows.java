...
public abstract class AnnotationHandlerMethodThrows<A extends Annotation, E> extends AnnotationHandlerBase<A, E> {
    ...
    public static class AnnotationHandlerThrowsOfMethod extends AnnotationHandlerBase<VoidAnnotation, LogunoScanner.ThrowsOfMethod> {
        ...
        public AnnotationHandlerThrowsOfMethod(JavacProcessingEnvironment environment) {
            super(environment);
        }
        ...
        public void processTree(VoidAnnotation annotation, LogunoScanner.ThrowsOfMethod element, ClassContext classContext) {
            ...
            if (method.getBody() == null || method.getBody().stats == null || method.getBody().stats.isEmpty())
                return;
            ...
            method.getBody().stats = com.sun.tools.javac.util.List.of(
